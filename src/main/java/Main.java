...
import model.InicializadorConversaoMoedas;
import model.InicializadorConversaoTemperatura;
import model.Repetidor;
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (executa) {
            ...
            if (!validador.verificar(valorString)) {
                ...
                BigDecimal valorConvertido = inicializadorConversao.operadorConversao(operacaoEspecifica, valorInicial);
